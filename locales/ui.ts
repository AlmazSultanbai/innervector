...
export const ui: Record<Locale, {
  ...
  ru: {
    ...
    subtitle: '144 вопроса · 36 характеристик · ~15 минут',
    modeExpress: '⚡ Express',
    modeFull: 'Full',
    subtitleExpress: '72 вопроса · 36 характеристик · ~15 минут',
    subtitleFull: '144 вопроса · 36 характеристик · ~30 минут',
    ...
    rankLabel: 'Ранг',
    expressResultBadge: 'Express · 72 вопроса',
    fullResultBadge: 'Full · 144 вопроса',
  },
  en: {
    back: 'Back',
    ...
    subtitle: '144 questions · 36 traits · ~15 min',
    modeExpress: '⚡ Express',
    modeFull: 'Full',
    subtitleExpress: '72 questions · 36 traits · ~15 min',
    subtitleFull: '144 questions · 36 traits · ~30 min',
    ...
    rankLabel: 'Rank',
    expressResultBadge: 'Express · 72 questions',
    fullResultBadge: 'Full · 144 questions',
  },
  ky: {
    back: 'Артка',
    ...
    subtitle: '144 суроо · 36 мүнөздөмө · ~15 мин',
    modeExpress: '⚡ Express',
    modeFull: 'Full',
    subtitleExpress: '72 суроо · 36 мүнөздөмө · ~15 мин',
    subtitleFull: '144 суроо · 36 мүнөздөмө · ~30 мин',
    ...
    rankLabel: 'Орун',
    expressResultBadge: 'Express · 72 суроо',
    fullResultBadge: 'Full · 144 суроо',
  },
}
